...
export default function ComposerActionsPopover({
  ...
  return (
    <Popover.Root open={open} onOpenChange={handleOpenChange}>
      ...
      <Popover.Content className="w-96 p-0" align="start" side="top">
        <div className="p-3 bg-zinc-950 border border-zinc-700 rounded-lg shadow-lg">
            ...
            {mainActions.map((action, index) => {
              ...
              return (
                <button
                  ...
                  className="flex items-center gap-3 w-full p-2 text-sm text-left hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg cursor-pointer"
                >
